...
|      [[short_doc/AlphaEvolve A coding agent for scientific and algorithmic discovery\|AlphaEvolve A coding agent for scientific and algorithmic discovery]]      | #agent #mechanism #evolution |                        AlphaEvolve transforms LLMs into a continuous algorithm discovery system by combining code generation with execution-based evaluation and evolutionary search.                        |
|       [[short_doc/IndexRAG Bridging Facts for Cross-Document Reasoning at Index Time\|IndexRAG Bridging Facts for Cross-Document Reasoning at Index Time]]       |         #RAG #reason         | IndexRAG shifts multi-hop reasoning from inference to indexing by precomputing cross-document connections as retrievable facts, enabling efficient single-pass retrieval with improved reasoning capability. |
|    [[short_doc/DeepRead Document Structure-Aware Reasoning to Enhance Agentic Search\|DeepRead Document Structure-Aware Reasoning to Enhance Agentic Search]]    |         #agent #RAG          |                        DeepRead transforms RAG from retrieving isolated chunks into a structure-aware “locate-then-read” process that enables coherent reasoning over long documents.                        |
